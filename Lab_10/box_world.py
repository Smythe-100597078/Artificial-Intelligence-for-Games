...
min_edge_cost = 0.0 # must be min value for heuristic cost to work
...
class BoxWorld(object):
    ...
    # Manhattan Distance - ideal for grids that allow 4-way movement 
    # Take the sum of the absolute values of the differences of coordinates

...
class Agent(object):
    ...
    def randomise_path(self):
        ...
        self.path.create_random_path(3,margin,margin,cx-margin,cy-margin,True)
    ...
    def render(self, color=None):
        ...
        if self.mode == "shooting":
           egi.green_pen()
           egi.circle(self.world.hunter.pos,10)
        ...
        if self.collided == True:
            self.color = 'RED'
            egi.white_pen()
            egi.text_at_pos(self.pos.x,self.pos.y,"Shot")    
